...
namespace Fanda.Shared.Utility
{
    public class PasswordStorage
    {
        ...
        public const int HASH_SECTIONS = 2;  // 5;

        //public const int HASH_ALGORITHM_INDEX = 0;
        //public const int ITERATION_INDEX = 1;
        //public const int HASH_SIZE_INDEX = 2;
        public const int SALT_INDEX = 0;    //3;

        public const int PBKDF2_INDEX = 1;  //4;
        ...
        public static bool VerifyPassword(string password, string goodHash)
        {
            ...
            byte[] testHash = PBKDF2(password, salt, PBKDF2_ITERATIONS/*iterations*/, hash.Length);
