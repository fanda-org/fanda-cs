...
namespace Fanda.Service.Business
{
    ...
    {
        Task<List<BankAccountViewModel>> GetAllAsync(AccountOwner owner, Guid? id, bool? active);

        Task<BankAccountViewModel> GetByIdAsync(Guid accountId);

        Task<BankAccountViewModel> SaveAsync(BankAccountViewModel accountVM);
