...
{
    public interface IProductCategoryService : IOrgService<ProductCategoryDto, ProductCategoryListDto> { }
    ...
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        public async Task<bool> ExistsAsync(BaseOrgDuplicate data) => await _context.ExistsAsync<ProductCategory>(data);
