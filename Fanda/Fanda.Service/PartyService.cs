...
namespace Fanda.Service
{
    ...
    {
        IQueryable<PartyDto> GetAll(string orgId/*, bool? active*/);
        Task<PartyDto> GetByIdAsync(string partyId);
        Task<bool> SaveAsync(string orgId, PartyDto partyVM);
    ...
    public class PartyService : IPartyService
    {
        ...
        public IQueryable<PartyDto> GetAll(string orgId/*, bool? active*/)
        {
        ...
        public async Task<PartyDto> GetByIdAsync(string partyId)
        {
        ...
        public async Task<bool> SaveAsync(string orgId, PartyDto partyVM)
        {
            if (string.IsNullOrEmpty(orgId))
                throw new ArgumentNullException("orgId", "Org id is missing");
