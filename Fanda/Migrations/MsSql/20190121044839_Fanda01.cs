...
namespace Fanda.Data.Migrations.MsSql
{
    public partial class Fanda01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrgUserId = table.Column<Guid>(nullable: false),
                    OrgId = table.Column<Guid>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgUser", x => x.OrgUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgUserRole", x => new { x.OrgUserId, x.RoleId });
                    table.ForeignKey(
